...
function TouchSection() {
    return (
        <div className={'mt-20 lg:mt-[160px] container mx-auto 2xl:max-w-[1675px] px-5 lg:px-0'}>
            <div className={'flex flex-col lg:flex-row justify-center items-center gap-y-[50px] lg:gap-y-0 lg:gap-x-[146px]'}>
                <div className={'w-fill lg:w-1/2'}>
                    <h2 className={'text-3xl lg:text-[51px] text-black1 font-medium'}>Consectetur<br/> adipiscing elit </h2>
                ...
                <div className={'flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-y-9 lg:gap-y-0 lg:gap-x-[103px]'}>
