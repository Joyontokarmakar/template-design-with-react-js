...
export default function Header() {
    return (
        <div className={'px-5 lg:px-10 2xl:px-[120px] py-6 lg:flex justify-between border-0 border-[#F3F3F3] shadow-shadow1'}>
            <div className={'flex justify-between lg:justify-start items-center gap-x-[50px] lg:gap-x-[80px] 2xl:gap-x-[150px] '}>
                <Link to={'/'}>
                    <img src={logo} alt="" className={'h-10 w-[202px]'}/>
                </Link>
                <div className={'hidden lg:flex justify-start items-center lg:gap-x-8 2xl:gap-x-20'}>
